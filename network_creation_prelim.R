...
graphs_path <- "~/Desktop/Repositories/MEC8_Snowbed_Alpine_Species/species_specific_df/old_tables"
...
# plot_nodes(gnap_pres_k_buff3, "Present - K", "3")
...
g_supinum_buff3 <- bind_rows(
  #gnap_pres_k_buff3 %>% mutate(scenario = "Present - K", buffer = "3"),
...
# gnap_pres_K_net <- euclidean_network_e2e(50, gnap_pres_k_buff3)      # present from K
...
# graph_plot_fun(gnap_pres_K_net$graph, 50, "Present - K")
...
gnap_net_metrics <- data.frame(
  rbind(net_metrics_fun(gnap_pres_net, "Present"),
       # net_metrics_fun(gnap_pres_K_net, "Present - K"),
...
# gnap_pres_K_node_metrics <- node_metrics_fun(gnap_pres_K_net, gnap_pres_k_buff3) 
